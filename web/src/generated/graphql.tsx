...
export type RegularEmailResponseFragment = (
  { __typename?: 'Email' }
  & Pick<Email, 'id' | 'senderEmail' | 'senderPhotoURL' | 'subject' | 'message' | 'createdAt'>
);
...
export type NewInviteSubscription = (
  { __typename?: 'Subscription' }
  & { newInvite: (
    { __typename?: 'Friend' }
    & RegularFriendResponseFragment
...
export function useDeclineInviteMutation() {
  return Urql.useMutation<DeclineInviteMutation, DeclineInviteMutationVariables>(DeclineInviteDocument);
};
...
export function useInviteFriendMutation() {
  return Urql.useMutation<InviteFriendMutation, InviteFriendMutationVariables>(InviteFriendDocument);
};
...
export function useEmailsQuery(options: Omit<Urql.UseQueryArgs<EmailsQueryVariables>, 'query'> = {}) {
...
export function useInvitesQuery(options: Omit<Urql.UseQueryArgs<InvitesQueryVariables>, 'query'> = {}) {
...
export function useNewEmailSubscription<TData = NewEmailSubscription>(options: Omit<Urql.UseSubscriptionArgs<NewEmailSubscriptionVariables>, 'query'> = {}, handler?: Urql.SubscriptionHandler<NewEmailSubscription, TData>) {
  return Urql.useSubscription<NewEmailSubscription, TData, NewEmailSubscriptionVariables>({ query: NewEmailDocument, ...options }, handler);
};
...
export function useNewInviteSubscription<TData = NewInviteSubscription>(options: Omit<Urql.UseSubscriptionArgs<NewInviteSubscriptionVariables>, 'query'> = {}, handler?: Urql.SubscriptionHandler<NewInviteSubscription, TData>) {
  return Urql.useSubscription<NewInviteSubscription, TData, NewInviteSubscriptionVariables>({ query: NewInviteDocument, ...options }, handler);
};